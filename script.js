...
document.querySelectorAll('.publication-link').forEach(link => {
    link.addEventListener('click', (e) => {
        ...
        if (linkText.includes('DOI')) {
            // Replace with actual DOI link
            alert('DOI link would open here');
        } else if (linkText.includes('PDF')) {
            // Replace with actual PDF link
            alert('PDF would download here');
        }
    });
});
...
document.querySelectorAll('.social-link').forEach(link => {
    link.addEventListener('click', (e) => {
        ...
        if (platform.includes('google-scholar')) {
            url = 'https://scholar.google.com/'; // Replace with actual profile
        } else if (platform.includes('researchgate')) {
            url = 'https://www.researchgate.net/'; // Replace with actual profile
        } else if (platform.includes('linkedin')) {
            url = 'https://linkedin.com/in/'; // Replace with actual profile
        } else if (platform.includes('github')) {
            url = 'https://github.com/'; // Replace with actual profile
        } else if (platform.includes('twitter')) {
            url = 'https://twitter.com/'; // Replace with actual profile
        }
...
const publicationFilterButtons = document.querySelectorAll('.publications-filter .filter-btn');
...
publicationFilterButtons.forEach(button => {
    button.addEventListener('click', () => {
        ...
        // Update active button
        publicationFilterButtons.forEach(btn => btn.classList.remove('active'));
        button.classList.add('active');
